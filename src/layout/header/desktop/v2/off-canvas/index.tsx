...
const offCanvasProps: IOffCanvas = {
  description:
    '¡Gracias por tu interés en contactarme! Si tienes alguna pregunta, sugerencia o simplemente quieres saludar, ¡estaré encantado de escucharte! Completa el formulario a continuación y me pondré en contacto contigo lo antes posible. ¡Espero poder ayudarte!',
  contactInfo: {
    location: ' 6380 , Eduardo Castex (LP), Plan 5000',
    phoneNumber: '(+54) 2334-409838',
      ...
      >
        ...
        >
          <div className="grid gap-10 p-30px">
            ...
            {/* Contact info  */}
            <div>
              <h3 className={mainTitleClasses}>CONTACTo INFO</h3>
