...
export const contactSectionData: ContactSectionProps = {
  sectionHeading: {
    title: 'Siéntete libre de enviar mensajes',
  },
  contactInfo: {
    sectionHeading: {
    title: 'Contacta con nosotros',
  description:
    'Si tienes alguna pregunta o deseas más información sobre nuestros servicios, no dudes en ponerte en contacto con nosotros. Completa el siguiente formulario y te responderemos a la brevedad posible.',
},
